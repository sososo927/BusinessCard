...
<%
    ...
    ArrayList<Notification_Bean> noList = noDAO.Returnselect(Integer.parseInt(loginUser.getLoginid()));
%>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-bold mb-8">返信待ち一覧</h1>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border-b text-center">
                        <button class="bg-blue-500 text-white py-2 px-4 rounded"
                            onclick="location.href='Notification_Servlet?action=returnwait&user_id=<%= no.getUser_id() %>'">
                            名刺を見る
                        </button>
                    </td>
                </tr>
