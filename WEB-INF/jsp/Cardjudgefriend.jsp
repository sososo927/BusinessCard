...
<body class="bg-gray-100">
    <div class="container mx-auto p-8 max-w-lg mt-10">
        ...
        <div class="flex space-x-4">
            <button class="bg-blue-500 text-white py-2 px-4 rounded" onclick="location.href='Notification_Servlet?action=answer&fl=yes&user_id=<%= no.getUser_id()%>'">確認</button>
            <button class="bg-gray-500 text-white py-2 px-4 rounded" onclick="location.href='Notification_Servlet?action=answer&fl=null'">戻る</button>
        </div>
    </div>
</body>
</html>